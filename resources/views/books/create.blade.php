...
<div class="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Add New Book</h2>
    ...
    <form action="{{ route('books.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-600" required>
            @error('title')
        ...
        <div class="mb-4">
            ...
            <input type="text" id="author" name="author" value="{{ old('author') }}" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-600" required>
            @error('author')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="quantity" name="quantity" value="{{ old('quantity', 1) }}" min="1" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-600" required>
            @error('quantity')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
